...
class PixelDiscriminator(GeneralDiscriminator):
    ...
    def __init__(self, n_input, n_hidden=64, norm_layer=nn.BatchNorm2d, use_dropout=False, device="cpu"): #havent used dropout!!!!!!!!
        """
        ...
        """
        super(PixelDiscriminator).__init__(n_input, device)
