...
def parse():
    ...
    # test arguments
    parser.add_argument('--test_model_date', default="stijn", type=str,
                        help='date_stamp string for which model to load')
    parser.add_argument('--test_model_suffix', default="klaus", type=str,
                        help='filename string for which model to load')
    ...
    parser.add_argument('--person', type=str, default='klaus')
